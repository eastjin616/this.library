							...
							<% } %>
								...
								<article class="container" id="container">
									...
									<div class="form-group">
										<label for="inputName">이름</label> <input type="text" class="form-control" name="name" value="name"
									...
									<div class="form-group">
										<label for="inputPassword">닉네임</label><input type="text" class="form-control" name="nickname"
											id="nickname" placeholder="닉네임을 2글자 이상 입력해주세요" required>
										<button class="btn btn-default addressbtn" type="button" onclick="checkNick()"
											id="dupl_btn">중복확인</button>
									</div>

									<div class="form-group">
										<label for="inputPassword">비밀번호</label> <label for=""></label><input type="password"
											class="form-control" name="password" id="password" placeholder="영문,숫자,특수문자 포함 8~16자" required>
									</div>

									<div class="form-group">
										<label for="inputPassword">비밀번호 확인</label> <input type="password" class="form-control"
											name="checkPassword" id="checkPassword" placeholder="비밀번호를 입력해주세요" oninput="checkpwd()" required>
									</div>
									<span id="pwd-result" style="margin-left: 25%;"></span> <br>
									<div class="form-group">
										<label>주소</label> <input type="text" class="form-control" id="zipNo" name="post" placeholder="우편번호">
										<button class="btn btn-default addressbtn" type="button" onClick="goPopup();" id="address_btn">
									...
									<div class="form-group">
										<label for="phone">PHONE</label> <input type="tel" class="form-control" name="phone"
