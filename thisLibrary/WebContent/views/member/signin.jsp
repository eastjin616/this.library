<%@page import="com.kh.member.model.vo.Member" %>
	<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
		<% String contextPath=request.getContextPath(); %>
			<% String alertMsg=(String)request.getAttribute("alertMsg"); Member
				loginMember=(Member)session.getAttribute("Member"); String
				kakaoNickName=(String)request.getAttribute("kakaoNickName"); String
				kakaoEmail=(String)request.getAttribute("kakaoEmail"); %>
						...
						<label for="InputEmail">이메일 주소</label> <input type="email"
							class="form-control" name="email" placeholder="이메일 주소를 입력해주세요">
											...
											<div class="form-group">
												<label>주소</label>
												<input type="text" class="form-control" id="zipNo" name="post" placeholder="우편번호">
												<button class="btn btn-default" type="button" onClick="goPopup();" id="addressbtn"><i
														class="fa fa-search"></i>주소검색</button>
											</div>
											...
											<div class="form-group">
												<label for="InputEmail">이메일 주소</label> <input type="email" class="form-control" name="email"
