				...
				<div id="content2_1">
					<div id="content2_1_1">
						<div id="contentDiv1_1">
							<img
								src="<%=contextPath%>/views/common/assets/interview_15747273.gif">
						</div>
					...
					<div id="content2_1_2">
						<div id="contentDiv2_1">
							<img
								src="<%=contextPath%>/views/common/assets/faq_12205153.gif">
						</div>
				...
				<div id="content2_2">
					<div id="content2_1_3">
						<div id="contentDiv3_1">
							<img
								src="<%=contextPath%>/views/common/assets/conversation_15578485.gif">
						</div>
					...
					<div id="content2_1_4">
						<div id="contentDiv4_1">
							<img
								src="<%=contextPath%>/views/common/assets/virtual-assistant_15579142.gif">
						</div>
