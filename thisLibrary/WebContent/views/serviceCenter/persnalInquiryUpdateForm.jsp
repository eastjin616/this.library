...
%>
        ...
        <body>
                ...
                <div class="post-container">
                    <h2>글쓰기</h2>
                    <hr>
                    <form action="<%=contextPath%>/update.sc" method="POST" enctype="multipart/form-data">
                    		<input type="hidden" name="bno" value="<%= sc.getInquiryNo()%>">
                        <label for="title" id="title" >제목</label>
                        <input type="text" id="title" name="title" value="<%=sc.getTitle() %>" style="width: 980px; margin-bottom: 10px;" required>
