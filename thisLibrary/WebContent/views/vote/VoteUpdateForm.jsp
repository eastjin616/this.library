						...
						<div id="post-content2">
							...
							<div class="container">
								...
								<div class="card btn-open-modalC" onclick="book1=1; book2=0;">
									...
									<img class="uploaded-image" id="selectBook1" src="<%=v.getBook1Url()%>">
								</div>
								<div class="card btn-open-modalC" onclick="book2=1; book1=0;">
									<span class="upload-icon">➕</span>
									<img class="uploaded-image" id="selectBook2" src="<%=v.getBook2Url()%>">
								</div>
							...
							<br>
							투표 종료일 : <input type="date" name="deadline" value="<%=v.getVoteEndDate() %>">
							<%=v.getVoteEndDate() %>
						</div>
							</p>
					</div>
