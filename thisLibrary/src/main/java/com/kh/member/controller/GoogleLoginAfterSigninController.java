...
/**
 * Servlet implementation class GoogleLoginAfterSigninController
 */
@WebServlet("/aftersignin.google")
public class GoogleLoginAfterSigninController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GoogleLoginAfterSigninController() {
        super();
